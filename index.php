  ...
  <style>
    * {
    ...
    .number-animation.show {
      animation: numberEmerge 3s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards;
    }
...
<body>
  ...
  <div class="container">
    <h1 class="title">🎁 Numero Mystère 🎁</h1>
  ...
  <script>
    ...
    function updateUI() {
      ...
      // MODIFIÉ: Ajout de 4 pour simuler les numéros 1, 2, 3, 4
      count.textContent = gameData.availableNumbers.length + 4;
    ...
    function createConfetti() {
      ...
      for (let i = 0; i < 50; i++) {
        ...
        confetti.style.animation = `confetti-fall ${Math.random() * 3 + 2
          }s linear infinite`;
